...
// Entry wrapper configuration for scroll animations
const scrollRevealVariants = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.8,
      ease: [0.16, 1, 0.3, 1] as [number, number, number, number], // premium ease-out curve
      staggerChildren: 0.1,
    },
  },
}
...
export const LandingPage: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-white text-charcoal overflow-hidden font-sans">
      ...
      <main>
        {/* Hero does not use scrollReveal (renders immediately) */}
        <Hero />
