...
export const ModernTheme: React.FC<ThemeProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] pb-24 font-sans select-none relative overflow-x-hidden">
      <div className="w-full max-w-2xl mx-auto px-6 py-20 md:py-28 space-y-28 relative">
        ...
        >
          <span className="text-[10px] uppercase font-bold tracking-widest text-[#D4A0A0] block">
            JOIN US TO CELEBRATE
          </span>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight uppercase text-neutral-900 leading-none">
          ...
          {quotes.text && (
            <p className="text-xs text-neutral-500 max-w-md mx-auto leading-relaxed font-sans px-6 pt-2">
              "{quotes.text}"
        ...
        <section className="space-y-12">
          <div className="text-center">
            <h3 className="text-2xl font-black uppercase tracking-wider text-neutral-900">THE COUPLE</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
            ...
            {schedules.akad && (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="p-6 border border-neutral-100 bg-white rounded-2xl space-y-4 shadow-none text-left">
        ...
        {stories.length > 0 && (
          <section className="space-y-12">
            ...
            <div className="relative border-l border-neutral-200 ml-4 pl-6 space-y-8 mt-6">
