      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            <span className="text-xs font-semibold uppercase tracking-widest text-gold-600 font-poppins">Solusi Kami</span>
            ...
            <div className="flex flex-col gap-8">
              {solutions.map((sol, i) => (
                ...
                >
                  <div className="p-3 bg-gold-50 border border-gold-100 rounded-xl shrink-0">{sol.icon}</div>
                  <div>
                    <h3 className="font-poppins font-semibold text-charcoal text-base sm:text-lg mb-1.5">{sol.title}</h3>
          ...
          <div className="lg:col-span-7 relative flex items-center justify-center py-8">
            ...
            >
              <div className="h-6 bg-charcoal/90 flex items-center px-3 gap-1.5 border-b border-charcoal/10">
                ...
                <span className="text-[10px] text-gray-500 font-mono ml-4 truncate">dashboard.ngaturi.id/wedding-reno-kirana</span>
              </div>
              <div className="bg-gray-50 h-full flex font-sans text-xs">
                <div className="w-1/4 bg-charcoal text-gray-400 p-2 flex flex-col gap-2 border-r border-gray-200">
                  ...
                  <div className="h-3 bg-gold-500/20 text-gold-500 rounded-xs px-1.5 py-0.5 font-medium flex items-center gap-1">📊 Dashboard</div>
                ...
                <div className="flex-1 p-4 overflow-hidden flex flex-col gap-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-emerald-500/10 text-emerald-600 px-1.5 py-0.5 rounded-sm font-semibold text-[8px]">AKTIF</span>
                  </div>
                  ...
                  <div className="flex-1 bg-white p-2 border border-gray-100 rounded-sm flex flex-col justify-between">
                    <span className="text-gray-400 text-[8px] font-semibold">Statistik Kehadiran</span>
            ...
            >
              ...
              <div className="w-full h-full bg-[#fdfcf9] rounded-xl overflow-hidden relative flex flex-col items-center justify-between py-6 px-3 border border-sand">
                ...
                <div className="text-center mt-3 relative z-10">
                  ...
                  <h4 className="font-serif text-sm font-bold text-charcoal mt-1">Reno &amp; Kirana</h4>
                </div>
                <div className="relative w-16 h-16 flex items-center justify-center z-10">
                  <div className="absolute inset-0 bg-gold-500/10 rounded-full animate-ping" />
                  <div className="relative p-2 bg-gold-500/20 text-gold-600 rounded-full"><Sparkles size={16} /></div>
                </div>
                <div className="flex flex-col items-center gap-2 relative z-10">
                  <span className="text-[7px] text-charcoal/60 uppercase tracking-widest font-semibold font-poppins">Kepada Yth:</span>
                  <span className="text-[8px] font-bold text-charcoal bg-gold-50 border border-gold-200 px-2 py-0.5 rounded-sm">Bapak Arya Mulya</span>
                  <button className="bg-gold-500 text-white font-poppins font-medium text-[8px] py-1 px-3.5 rounded-full shadow-xs mt-1 hover:bg-gold-600 transition-colors">Buka Undangan</button>
                </div>
              </div>
            </motion.div>
          </div>
