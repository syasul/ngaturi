...
export const Theme2: React.FC<Theme2Props> = ({
    ...
    return (
        <div className="flex min-h-screen w-full overflow-hidden bg-[#FDF9F1] text-[#3E2723]" style={{ colorScheme: 'only light' }}>
            {/* DESKTOP LEFT PANEL */}
            ...
            {/* RIGHT PANEL */}
            <div className="relative h-screen h-[100dvh] w-full overflow-hidden lg:w-[30%]">
                <AnimatePresence>
                    {!isOpened && onOpen && (
                        <OpeningCover
                            onOpen={onOpen}
                        ...
                        >
                            ...
                            {(customStyle.qrisUrl || customStyle.ewalletNumber) && (
                                <button
                                    ...
                                    className="rounded-full border border-[#C9A84C]/35 bg-white p-3.5 text-[#4A3B32] shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95"
                            ...
                            <button
                                ...
                                className="relative flex h-12 w-12 items-center justify-center rounded-full border-[1.5px] border-[#C9A84C]/40 bg-[#3A322C] shadow-[0_4px_20px_-5px_rgba(58,5,17,0.5)] transition-all duration-300 hover:scale-105 active:scale-95"
                                title="Toggle Music"
                            >
                                <div
                        ...
                        >
                            ...
                            {(guestName || guestToken) && (
                                <button
                                    ...
                                    className="rounded-full border border-[#C9A84C]/35 bg-[#4A3B32] p-3.5 text-white shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95"
                            ...
                            {/* NAVIGATION MENU BUTTON (MENTOK BAWAH / DI ATAS NAVBAR) */}
                            <button
                                onClick={() => setIsMenuOpen(true)}
                                className="rounded-full border border-sand/35 bg-white p-3.5 text-[#4A3B32] shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95"
                                title="Menu"
                            >
                                <Menu size={20} />
                            </button>
