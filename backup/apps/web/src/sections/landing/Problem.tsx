  ...
  return (
    <section id="problem" className="relative pt-24 pb-32 bg-cream/30">
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        {/* Title */}
        <div className="mb-16">
          <span className="text-xs font-semibold uppercase tracking-widest text-rustic-600 font-poppins">
            Tantangan & Masalah
          </span>
          ...
          {problems.map((prob, i) => (
            ...
            >
              <Card className="h-full flex flex-col items-start p-8 hover:border-red-200 bg-white">
                ...
                <h3 className="font-poppins font-semibold text-charcoal text-lg mb-3">
                  {prob.title}
                </h3>
      ...
      {/* Elegant wave transition wrapper */}
