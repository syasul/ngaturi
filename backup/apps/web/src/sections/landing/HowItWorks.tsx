      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="relative flex flex-col lg:flex-row gap-8 items-stretch justify-between">
          ...
          {steps.map((item, i) => (
            ...
            >
              {/* Step Badge */}
              <div className="absolute top-4 right-6 text-gold-400/30 font-mono text-3xl font-bold font-poppins select-none">
                {item.step}
              </div>
              ...
              {/* Text info */}
              <h3 className="font-poppins font-bold text-charcoal text-base sm:text-lg mb-3">
                {item.title}
              </h3>
              <p className="font-sans text-xs sm:text-sm text-charcoal/60 leading-relaxed max-w-[240px]">
                {item.desc}
              </p>
            </motion.div>
          ))}
