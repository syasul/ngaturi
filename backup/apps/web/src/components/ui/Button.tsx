...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-gold-500 hover:bg-gold-600 text-white shadow-md hover:shadow-lg',
    secondary: 'bg-rustic-500 hover:bg-rustic-600 text-white shadow-md hover:shadow-lg',
