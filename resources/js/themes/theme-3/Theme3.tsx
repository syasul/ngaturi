...
const Theme3Countdown = ({ targetDate }: { targetDate: string }) => {
...
interface Theme3Props extends ThemeProps {
    isOpened?: boolean;
    onOpen?: () => void;
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            {customStyle.ewalletNumber && (
                                                <div className="rounded-[1.25rem] border border-[#7A223E]/15 bg-gradient-to-br from-white/90 to-[#FCF0F2]/90 p-6 text-left shadow-[0_4px_20px_-10px_rgba(122,34,62,0.15)] backdrop-blur-md">
                                                    <div className="mb-6 flex items-center justify-between">
                                                        <div className="flex items-center gap-4">
                                                            <div className="flex h-5 w-8 items-center justify-center rounded-[3px] bg-[#7A223E] text-white p-[3px]">
                                ...
                                <div className="space-y-6">
                                    ...
                                    {customStyle.ewalletNumber && (
                                        <div className="rounded-[1rem] border border-[#7A223E]/15 bg-white p-4 text-left shadow-sm">
                                            <div className="mb-2 flex items-center justify-between text-[11px] font-bold text-[#7A223E]" style={{ color: primaryColor }}>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <p className="font-sans text-[1.15rem] font-bold tracking-wide" style={{ color: primaryColor }}>
                                                    {customStyle.ewalletNumber}
                                                </p>
                                                <button
                                                    onClick={() => handleCopyEWallet(customStyle.ewalletNumber)}
                                                    className="flex items-center justify-center gap-1 rounded-full border border-[#7A223E]/20 px-2.5 py-1 text-[7px] font-bold transition-all hover:bg-neutral-50"
                                                    style={{ color: primaryColor }}
                                                >
                                            ...
                                            {customStyle.ewalletHolderName && (
                                                <p className="mt-1 font-serif text-[9px] font-bold" style={{ color: primaryColor }}>
                                                    a.n {customStyle.ewalletHolderName}
                                                </p>
                                            )}
                                        </div>
