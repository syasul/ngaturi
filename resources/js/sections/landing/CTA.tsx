  ...
  return (
    <section className="relative py-28 overflow-hidden bg-gradient-to-b from-[#252320] to-[#121110] text-white">
      ...
      <img src="/assets/wedding/ornaments.png" alt="" aria-hidden="true"
        className="absolute top-0 left-0 w-44 opacity-[0.1] pointer-events-none select-none" />
      <img src="/assets/wedding/ornaments.png" alt="" aria-hidden="true"
        className="absolute bottom-0 right-0 w-44 opacity-[0.1] pointer-events-none select-none rotate-180" />
